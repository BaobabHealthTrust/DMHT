...
function createLoadingMessage(){
    ...
    "font-style: italic; border: 1px solid #fff; text-align: center;'>" + (typeof(tstLocaleWords) != "undefined" ? 
(tstLocaleWords["loading. please wait"] ? tstLocaleWords["loading. please wait"] : "Loading. Please Wait") : "Loading. Please Wait") + "...</div>";
